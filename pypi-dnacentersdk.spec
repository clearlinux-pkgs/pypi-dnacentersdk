...
Source0  : https://files.pythonhosted.org/packages/5e/39/216999c6693e50c37b9fd71acde77f829f9c09b3f37e4d7770447257b1e7/dnacentersdk-2.4.10.tar.gz
...
%prep
%setup -q -n dnacentersdk-2.4.10
cd %{_builddir}/dnacentersdk-2.4.10
pushd ..
cp -a dnacentersdk-2.4.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654702878
