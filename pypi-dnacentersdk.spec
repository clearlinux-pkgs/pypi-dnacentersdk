...
Source0  : https://files.pythonhosted.org/packages/27/6e/75b0ce96914e2eb04b17e04367fb211b36d776f9667bbea386f4b87d7d3a/dnacentersdk-2.5.6.tar.gz
...
%prep
%setup -q -n dnacentersdk-2.5.6
cd %{_builddir}/dnacentersdk-2.5.6
pushd ..
cp -a dnacentersdk-2.5.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673385965
