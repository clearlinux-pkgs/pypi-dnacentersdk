...
Source0  : https://files.pythonhosted.org/packages/72/c9/bcc58488f35e7699bfbf9a3adfed0265efd4000b0c90a51d7e21fae75c0a/dnacentersdk-2.7.7.tar.gz
...
%prep
%setup -q -n dnacentersdk-2.7.7
cd %{_builddir}/dnacentersdk-2.7.7
pushd ..
cp -a dnacentersdk-2.7.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732066183
