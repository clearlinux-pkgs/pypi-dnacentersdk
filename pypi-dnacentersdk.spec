...
Version  : 2.7.1
Release  : 35
URL      : https://files.pythonhosted.org/packages/8b/94/93fca4abe9df07f54f20cf01cebc40cd79521dca084a1764f581eee50662/dnacentersdk-2.7.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/8b/94/93fca4abe9df07f54f20cf01cebc40cd79521dca084a1764f581eee50662/dnacentersdk-2.7.1.tar.gz
...
%prep
%setup -q -n dnacentersdk-2.7.1
cd %{_builddir}/dnacentersdk-2.7.1
pushd ..
cp -a dnacentersdk-2.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717431969
