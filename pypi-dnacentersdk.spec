...
Version  : 2.7.4
Release  : 38
URL      : https://files.pythonhosted.org/packages/c2/f5/347bd7fa4fb2eed4c2f21e2e5285595be855be17c699bd4193614a129f64/dnacentersdk-2.7.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/c2/f5/347bd7fa4fb2eed4c2f21e2e5285595be855be17c699bd4193614a129f64/dnacentersdk-2.7.4.tar.gz
...
%prep
%setup -q -n dnacentersdk-2.7.4
cd %{_builddir}/dnacentersdk-2.7.4
pushd ..
cp -a dnacentersdk-2.7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726671129
...
cp %{_builddir}/dnacentersdk-%{version}/dnacentersdk/api/v2_3_7_6/licenses.py %{buildroot}/usr/share/package-licenses/pypi-dnacentersdk/68772f7e71008a8193309a0152260ecc0d7cb112 || :
...
/usr/share/package-licenses/pypi-dnacentersdk/68772f7e71008a8193309a0152260ecc0d7cb112
