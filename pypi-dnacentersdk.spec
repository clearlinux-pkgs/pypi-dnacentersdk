...
Version  : 2.9.1
Release  : 58
URL      : https://files.pythonhosted.org/packages/45/fb/dd824cd7b552e7d2fcada514ce32b0c5cfc05aa047277b669b89f0bc4170/dnacentersdk-2.9.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/45/fb/dd824cd7b552e7d2fcada514ce32b0c5cfc05aa047277b669b89f0bc4170/dnacentersdk-2.9.1.tar.gz
...
%prep
%setup -q -n dnacentersdk-2.9.1
cd %{_builddir}/dnacentersdk-2.9.1
pushd ..
cp -a dnacentersdk-2.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747233108
...
cp %{_builddir}/dnacentersdk-%{version}/dnacentersdk/api/v3_1_3_0/licenses.py %{buildroot}/usr/share/package-licenses/pypi-dnacentersdk/5a621585f9d0396734294358917665bbf91af8bf || :
...
/usr/share/package-licenses/pypi-dnacentersdk/5a621585f9d0396734294358917665bbf91af8bf
