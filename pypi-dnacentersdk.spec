...
Version  : 2.8.10
Release  : 52
URL      : https://files.pythonhosted.org/packages/83/d8/900fa711e39c33a5c97df319be59c86fc90b4bd4c68cf04eb7b27e9ef619/dnacentersdk-2.8.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/83/d8/900fa711e39c33a5c97df319be59c86fc90b4bd4c68cf04eb7b27e9ef619/dnacentersdk-2.8.10.tar.gz
...
%prep
%setup -q -n dnacentersdk-2.8.10
cd %{_builddir}/dnacentersdk-2.8.10
pushd ..
cp -a dnacentersdk-2.8.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743537634
